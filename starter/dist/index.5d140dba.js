...
var _shoppingCartJs = require("./shoppingCart.js"); //So remember that all the importing statements are basically hoisted to the top. even if we wrote them below some codes
...
console.log('we are importing module'); //this to work we need to (connect module to html file)add atrubute  type to module in the html// type=module
// //we got output   1.we are exporting   2.we are importing    first with the exported one b/c the exported one should down load first
_shoppingCartJs.addToCart('bread', 12);
console.log(_shoppingCartJs.totalPrice, _shoppingCartJs.totalQuantity); //237 23
_shoppingCartJsDefault.default('pizza', 3); //pizza, 3
_shoppingCartJsDefault.default('fish', 1);
_shoppingCartJsDefault.default('orange', 6);
console.log(_shoppingCartJs.cart); //we get the output  with array filled  the added product and quantity
const state = {
    cart: [
        {
            product: 'bread',
...
const stateClonedeep = _cloneDeepJsDefault.default(state);
state.user.loggedIn = false;
console.log(stateClone);
console.log(stateClonedeep); /////////////parcel
...
which is probably the most popular bundler and especially in react world.However, it's way too complex to use in a course like this.*/  // to install parcel       npm i parcel --save-dev       parcel is saved as development  dependencies
...
},{"./_getTag.js":"lchEy","./isObjectLike.js":"85060","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["hlItI","8fvzf"], "8fvzf", "parcelRequire7e89")
